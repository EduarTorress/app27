                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <form class="form-inline" id="form-search">
                                ...
                                ?> &nbsp;
                                <?php
                                $cat = new \App\View\Components\CategoriaComponent(0);
                                echo $cat->render();
                                ?>&nbsp;
                                <?php
                                $mar = new \App\View\Components\MarcaComponent(0);
                                echo $mar->render();
                                ?>&nbsp;
...
<script>
    ...
    window.onload = function() {
        ...
        $("#cmbcategoria").append('<option value="0">TODOS</option>')
        $("#cmbcategoria").val("0");
    ...
    function search() {
        ...
        axios.get('/vtas/listarutilidadesdetalle', {
            "params": {
                "dfechai": dfechai,
                "dfechaf": dfechaf,
