                        ...
                        <div class="card-body">
                            <form class="form-inline" id="form-search">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input type="date" id="txtfecha" readonly value="<?php echo date('Y-m-d'); ?>" class="form-control form-control-sm" aria-describedby="">
                                    </div>
                                    <?php
...
<script>
    ...
    function search() {
        ...
        axios.get('/inventarios/listaproductosmenosrotados', {
            "params": {
