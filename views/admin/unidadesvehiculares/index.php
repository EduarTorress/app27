                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8" style="display:inline-block;">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="txtbuscar" id="txtbuscar" placeholder="Ingrese el nombre del chofer del vehículo" onkeyup="mayusculas(this)">
...
<script>
    ...
    function store(modo, id) {
        ...
        if (cnombre.length == 0) {
            toastr.error('Ingrese el nombre de un Chofer', 'Mensaje del Sistema');
            return;
        }
