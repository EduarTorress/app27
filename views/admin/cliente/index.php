...
<script>
    ...
    function buscar() {
        ...
        if (abuscar.length == 0) {
            toastr.error("Ingrese el cliente a buscar", 'Mensaje del Sistema');
            return;
        }
    ...
    function modalEdit(id) {
        ...
        axios.get(ruta)
            .then(function(respuesta) {
                ...
                toastr.error('Error al cargar el modal de editar' + error, 'Mensaje del sistemas')
            })
    }
    ...
    function store(modo, id) {
        ...
        if (cdireccion.length == 0 || cciudad.length == 0) {
            toastr.error('Ingrese una dirección del cliente', 'Mensaje del Sistema');
            return;
        }
