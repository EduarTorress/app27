<?php
//require_once('apiCore\ClasesXMLSecurityKey.php');
//require_once'api_signature/XMLSecurityDSig.php');
//require_once('a\pi_signature/XMLSecEnc.php');
namespace Core\Clases;
use Core\Clases\api_signature\XMLSecurityKey;
use Core\Clases\api_signature\XMLSecurityDSig;
use Core\Clases\api_signature\XMLSecEnc;
use DOMDocument;
class Signature {
